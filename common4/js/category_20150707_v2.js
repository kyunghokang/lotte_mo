...
var api_domain = LOTTE_CONSTANTS['MAPI_HOST_API'];
...
function loadBarndKeyword() {
	...
	var brandKeywordSearch = function($loading) {
		...
		if($("#brandKeyword").val() == "") {
			...
			var resultHtml = "<ul>\n"
			resultHtml += "</ul>\n";
			resultHtml += "<p class=\"noList\" style=\"display:none;\" id=\"bkNullResult\">브랜드 검색결과가 없습니다.</p>";
		...
		$.ajax({
			...
			, success: function(data) {
	            ...
	            resultHtml += "</ul>\n";
	            resultHtml += "<div class=\"noList result\" style=\"display:none;\" id=\"bkNullResult\">브랜드 검색결과가 없습니다.</div>";
	            resultHtml += "<a class=\"btn_close\">닫기</a>";
