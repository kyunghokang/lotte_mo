...
var _n_c_field1="CHLNO";			/* 추가쿠키 필드1 */
var _n_c_field2="CHLDTLNO";			/* 추가쿠키 필드2 */
var _n_c_field3="SITENO";			/* 추가쿠키 필드3 */

var _n_sid = "07010100000";		/* custid */
var _n_ls = "http://wiselog.lotte.com/wlo/Logging";		/* logging server */
var _n_uls = "http://wiselog.lotte.com/wlo/UserLogging";	/* user logging server */
var _n_uid = "";			/* uid */
...
if ( document.location.protocol == "https:" ) {
	_n_ls = "https://wiselog.lotte.com/wlo/Logging";
	_n_uls = "https://wiselog.lotte.com/wlo/UserLogging";
}
