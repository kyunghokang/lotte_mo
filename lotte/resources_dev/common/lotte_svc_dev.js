...
(function(window, angular, undefined) {
	...
	urlSvc.service('LotteCommon', ['$location', 'LotteCookie', function ($location, LotteCookie) {
		...
		this.baseUrl = "http://molocal.lotte.com";
...
//        this.testlocal = "http://mrenewdev.lotte.com";
		...
		this.mainUrl = "/main/main_2017_dev.html";
		this.mainContentData = "/json/main/main_contents.json";
    ...
    //  this.getJoinBtnViewAjaxUrl = "/json/login/getJoinBtnViewAjax.json";   //회원가입 앱 테스트 기간 URL
		...
		this.registAttendData = this.baseUrl + '/json/event/regist_attend.json'; // 출석도장 이벤트
...
//        this.srhBestData = "/lotte/resources_dev/data/search/srh_best_data.html"; // 검색 레이어 인기 급상승 키워드 데이터
		...
		this.prdAddWish = "/lotte/resources_dev/data/product_add_wish.html"; /*상품 위시리스트 추가*/
		...
		this.eventRegistUrl = this.testlocal + "/json/event/regist_saun.json"; /* 이벤트 등록 */
		...
		this.srhListData2016 = "/json/search/m/getSearch2016List.jsp";//"/json/search/m/getSearch2016List.json";// 검색결과 데이터
		this.srhListTermData2016 = "/json/search/m/getSearch2016Term.jsp";//"/json/search/m/getSearch2016Term.json";//검색결과 조건 활성화 여부 데이터
		...
		this.prdviewUrl = "http://m.lotte.com/product/product_view.do"; /*상품상세 */
		...
		**/
		this.productProductViewData = (function () { // 상품상세 코드별 로컬 데이터를 보기 위해 처리
			return "/json/product/product_view_" + getUrlParams().goods_no + ".json";
		}());
		...
		this.productDetailData = "/json/product/product_detail_" + getUrlParams().goods_no + ".json";		/*[상품상세] 상품상세 Html정보*/
		...
		this.productCommentData = "/json/product/comment_info_" + getUrlParams().goods_no + ".json";		/*[상품상세] 상품평 정보*/
		...
		this.prodSubCommentDetailData = "/json/product/comment_info_"+ getUrlParams().goods_no +".json";	/*[상품상세 서브페이지] 상품평 상세보기*/
		...
		this.purchaseViewUrl = "";  /*주문/배송조회 상세*/
		this.critViewUrl = "/mylotte/product/m/mylotte_crit_view_dev.html";  /*상품평 관리*/
		this.mylotteUrl = "/mylotte/m/mylotte_dev.html" /* 마이롯데 메인 */
		this.ordCancelUrl = ""; /*주문취소*/
		this.ordChangeUrl = ""; /*주문변경*/
		this.prdReturnUrl = ""; /*교환/반품*/
		this.myCouponUrl = "";  /*내쿠폰*/
	   ...
	   // this.receiptListData = this.testlocal + "/json/mylotte/receipt_issue_info.json"; /* 영수증 데이터 */
		...
		/* agreement */
		this.companyUrl = "/agreement/company_dev.html";      /*회사소개*/
...
//        this.commentCommentViewMobileData = "/lotte/resources/data/comment_view_mobile.html";     /*[상품상세]상품평 목록데이터  test용 */
		...
		this.styleShopUrl = "/styleshop/styleshop_dev.html"; // 스타일샵
