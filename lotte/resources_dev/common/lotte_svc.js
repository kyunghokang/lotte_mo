(function(window, angular, undefined) {
	...
	urlSvc.service('LotteCommon', ['$location', function ($location) {
		...
		this.loginData = this.localUrl + "/json/cn/login_check.json";
		...
		this.receiptEvtUrl = this.localUrl + "/event/receipt.do"; /* 영수증 이벤트 */
		this.frequentBuyPrdUrl = this.localUrl + "handler/mypage/wishlist/QuickBuy-OftenBuyList"; /* 자주 구매 상품 */
		...
		this.specMall2017Cate	= this.baseUrl + "/json/mall/getKshopCtgListNew.json";
		this.specMall2017Main	= this.baseUrl + "/json/mall/getKshopMain.json";
		this.specMall2017Sub	= this.baseUrl + "/json/mall/getKshopGoodsList.json";

		this.specialMallUrl = "/mall/spec_mall.do"; // 전문관 URL
		this.specialSubUrl = "/mall/spec_mall_sub.do"; // 전문관 URL

		this.tenbytenUrl = this.baseUrl + "/mall/tenbyten/m/tenbyten_main.do"; /* 텐바이텐 URL */
		...
		this.bookshopUrl = this.baseUrl + "/mall/book_shop/m/book_shop_main.do"; /* 도서몰 URL */
		...
		this.vineUrl = this.baseUrl + "/mall/webzine/m/lzine_list.do"; /* 바인 URL */
		...
		this.prdviewUrl = this.baseUrl + "/product/m/product_view.do";			/*상품상세*/
		this.prdviewRecobellShareData = this.baseUrl + "/product/regBestProd.do"; // 상품상세 Recobell Share 데이터 수집 URL
		this.productviewUrl = "/product/m/product_view.do"; /*상품상세*/
		...
		this.productExtInfoUrl = "/product/m/sub/product_ext_info.do"; /* 배송/교환/반품/결제정보 안내 페이지 URL */

		this.productSubComment = "/product/m/sub/product_comment.do";	/*[상품상세 서브페이지] 상품평 보기 페이지*/
		this.productSubCommentDetail = "/product/m/sub/product_comment_detail.do";	/*[상품상세 서브페이지] 상품평 상세 보기 페이지*/
...
//		this.productProductViewData = this.localUrl + "/json/product/product_view.json";			/*상품상세 기본정보*/
		...
		this.centerQueUrl = this.secureUrl + "/custcenter/m/question.do"; /* 1:1문의 바로가기 URL */
		...
		this.styleShopUrl = "/styleshop/styleshop.do"; // 스타일샵
    ...
    this.petMallAdviceUrl="/mall/pet/mitou_advice.do"
		...
		this.talkShopDelevery	= "/popup/talk_delivery_service.do";//배송지 수정 page
		this.talkShopPayment	= "/popup/talk_base_pay.do";//결제수단 수정 page
		this.talkShopOrderFrame	= "/order/m/order_form.do";//결제 아이프레임
