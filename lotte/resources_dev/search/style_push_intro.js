(function(window, angular, undefined) {
	...
	app.controller('StylePushIntroCtrl', ['$http', '$scope', 'LotteCommon', '$timeout', function ($http, $scope, LotteCommon, $timeout) {
		...
		$scope.topBanner = [
			{img_url : 'http://image.lotte.com/lotte/mo2018/search/style_intro_01.jpg', img_url_tablet : 'http://image.lotte.com/lotte/mo2015/angular/search/style_intro_1440_01.jpg'},
			{img_url : 'http://image.lotte.com/lotte/mo2018/search/style_intro_02.jpg', img_url_tablet : 'http://image.lotte.com/lotte/mo2015/angular/search/style_intro_1440_02.jpg'},
			{img_url : 'http://image.lotte.com/lotte/mo2018/search/style_intro_03.jpg', img_url_tablet : 'http://image.lotte.com/lotte/mo2015/angular/search/style_intro_1440_03.jpg'}
		];
	...
	app.directive('lotteContainer', function() {
		return {
			templateUrl : '/lotte/resources_dev/search/style_push_intro_container.html',
			replace : true,
