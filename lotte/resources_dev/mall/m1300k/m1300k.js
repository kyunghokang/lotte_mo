(function(window, angular, undefined) {
    ...
    app.controller('m1300kCtrl', ['$http','$scope', '$window', 'LotteCommon', function($http, $scope, $window, LotteCommon) {
        $scope.showWrap = true;
        $scope.contVisible = true;
        $scope.subTitle = "1300K"; //서브헤더 타이틀
    ...
    app.directive('lotteContainer',['LotteCommon', function(LotteCommon) {
        return {
            templateUrl : '/lotte/resources_dev/mall/m1300k/m1300k_container.html',
            replace : true,
