(function(window, angular, undefined) {
	...
	app.directive('m2162Container', ['$timeout', '$window', '$document', '$location', 'LotteCommon', 'LotteCookie', 'LotteStorage', 'LotteUtil', 'LotteUserService', '$http',
	function ($timeout, $window, $document, $location, LotteCommon, LotteCookie, LotteStorage, LotteUtil, LotteUserService, $http) {
		return {
			restrict: 'AEC',
			scope: { moduleData : "="},
			templateUrl : "/lotte/resources_dev/main/modules/m2162.html",
            replace : true,
