...
(function(window, angular, undefined) {
	...
	app.directive('m2010Container', ['LotteUtil', '$timeout', '$window', '$location', 'LotteCommon', 'LotteCookie', 'LotteStorage',
		function (LotteUtil, $timeout, $window, $location, LotteCommon, LotteCookie, LotteStorage) {
			return {
				restrict: 'AEC',
				scope: { moduleData : "=" },
				templateUrl : "/lotte/resources_dev/main/modules/m2010.html",
				replace : true,
