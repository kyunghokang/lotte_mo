(function(window, angular, undefined) {
	...
	app.directive('m2106Container', ['$timeout', '$window', '$location', 'LotteCommon', 'LotteCookie', 'LotteStorage', 'LotteUtil', 
		function ($timeout, $window, $location, LotteCommon, LotteCookie, LotteStorage, LotteUtil) {
			return {
				...
				templateUrl : "/lotte/resources_dev/main/modules/m2106.html",
				link : function ($scope, el, attrs) {
                    ...
                    setTimeout(function(){
                        angular.element(el).find(".swipeBox").on({"touchstart.cdb" : function(e){
                            e.stopPropagation();
                        }});                        
                    }, 200);
