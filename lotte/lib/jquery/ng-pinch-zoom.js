...
.directive('ngPinchZoom', function() {
  ...
  function _link(scope, element, attrs) {
    ...
    image.onload = function() {
      ...
      element.on('resetPinch', resetPinchHandler);
    };

    var path = attrs.ngSrc ? attrs.ngSrc : attrs.src;
    if(scope.isValidString(path)){
    	image.src = path;
    }
