...
<head>
    ...
    <script src="/ellotte/resources_dev/mall/m1300k/m1300k.js"></script>
    <% } else {  %>
    	<%@include file="/common3/html_meta_angular.jsp"%>
		<link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/m1300k.min.css"/>
		<script src="/lotte/resources/<%= pubVersion %>/m1300k.min.js"></script>
		<script src="/lotte/resources/<%= pubVersion %>/m1300k.tpl.js"></script>
    <% } %>
</head>
<body ng-controller="m1300kCtrl">
