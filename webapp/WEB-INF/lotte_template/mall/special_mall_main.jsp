...
<head>
    ...
    <!-- 이 화면에서 쓰이는 CSS -->
	<link rel="stylesheet" type="text/css" href="/lotte/resources_dev/tenbyten/tenbyten.css">
    ...
    <script src="/ellotte/resources_dev/mall/special_mall_main.min.js"></script>
    <% } else {  %>
    	<%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%=pubVersion%>/special_mall_main.min.css"/>
	    <script src="/lotte/resources/<%=pubVersion%>/special_mall_main.min.js"></script>
	    <script src="/lotte/resources/<%=pubVersion%>/special_mall_main.tpl.js"></script>
    <% } %>
</head>
<body ng-controller="SpecialMallMainCtrl">
