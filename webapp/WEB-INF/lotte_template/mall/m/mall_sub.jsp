...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/lotte/resources_dev/specialshop/specialshop.css">
	<link rel="stylesheet" type="text/css" href="/lotte/resources_dev/search/search_list.css">
	<link rel="stylesheet" type="text/css" href="/lotte/resources_dev/category/category.css">
	<link rel="stylesheet" type="text/css" href="/lotte/resources_dev/mall/m/mall_sub.css">
    ...
    <script src="/lotte/resources_dev/mall/m/mall_sub.js"></script>
    <% } else {  %>
	    <%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/mall_sub.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/mall_sub.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/mall_sub.tpl.js"></script>
...
<body ng-controller="MallSubCtrl">
