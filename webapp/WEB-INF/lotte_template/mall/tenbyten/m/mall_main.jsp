...
<head>
    ...
    <script src="/lotte/resources_dev/mall/tenbyten/m/mall_main.js"></script>
    <% } else {  %>
		<%@include file="/common3/html_meta_angular.jsp"%>
		<link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/mall_main.min.css"/>
		<script src="/lotte/resources/<%= pubVersion %>/mall_main.min.js"></script>
		<script src="/lotte/resources/<%= pubVersion %>/mall_main.tpl.js"></script>
    <% } %>
</head>
<body ng-controller="MallMainCtrl">
