...
<head>
    ...
    <!-- 이 화면에서 쓰이는 CSS -->
    <link rel="stylesheet" type="text/css" href="lotte/resources_dev/mall/special_flavor/special_flavor.css" />

    <!-- 이 화면에서 쓰이는 JS -->
    <script src="lotte/resources_dev/mall/special_flavor/special_flavor.js"></script>
    <script src="lotte/resources_dev/common/lotte_ngswipe.js"></script>
    
    <% } else {  %>
    <%@include file="/common3/html_meta_angular.jsp"%>
    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/special_flavor.min.css"/>
    <script src="/lotte/resources/<%= pubVersion %>/special_flavor.min.js"></script>
    <script src="/lotte/resources/<%= pubVersion %>/special_flavor.tpl.js"></script>
...
<body ng-controller="specialFlavorCtrl">
