...
<head>
    ...
    <script src="/ellotte/resources_dev/mall/m1200m/m1200m.js"></script>
    <% } else {  %>
    	<%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%=pubVersion%>/m1200m.min.css"/>
	    <script src="/lotte/resources/<%=pubVersion%>/m1200m.min.js"></script>
	    <script src="/lotte/resources/<%=pubVersion%>/m1200m.tpl.js"></script>
    <% } %>
</head>
<body ng-controller="m1200mCtrl">
