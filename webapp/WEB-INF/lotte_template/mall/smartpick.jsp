...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="lotte/resources_dev/mall/smartpick.css" />

    <!-- 이 화면에서 쓰이는 JS -->
    <script src="lotte/resources_dev/mall/smartpick.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/smartpick.min.css"/>
    <script src="/lotte/resources/<%= pubVersion %>/smartpick.min.js"></script>
    <script src="/lotte/resources/<%= pubVersion %>/smartpick.tpl.js"></script>
...
<body ng-controller="smartpickCtrl">
