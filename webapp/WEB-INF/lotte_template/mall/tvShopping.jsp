...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="lotte/resources_dev/mall/tvshopping.css" />

    <!-- 이 화면에서 쓰이는 JS -->
    <script src="lotte/resources_dev/mall/tvshopping.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/tvshopping.min.css"/>
    <script src="/lotte/resources/<%= pubVersion %>/tvshopping.min.js"></script>
    <script src="/lotte/resources/<%= pubVersion %>/tvshopping.tpl.js"></script>
...
<body ng-controller="tvShoppingCtrl">
