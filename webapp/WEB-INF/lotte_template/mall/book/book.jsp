...
<head>
    ...
    <script src="/lotte/resources_dev/mall/book/book.js"></script>
    <% } else {  %>
		<%@include file="/common3/html_meta_angular.jsp"%>
		<link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/book.min.css"/>
		<script src="/lotte/resources/<%= pubVersion %>/book.min.js"></script>
		<script src="/lotte/resources/<%= pubVersion %>/book.tpl.js"></script>
    <% } %>
</head>
