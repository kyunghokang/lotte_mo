...
<head>
    ...
    <script src="/lotte/resources_dev/mall/gucci/gucci_main.js"></script>
    <% } else {  %>
		<%@include file="/common3/html_meta_angular.jsp"%>
		<link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/gucci_main.min.css"/>
		<script src="/lotte/resources/<%= pubVersion %>/gucci_main.min.js"></script>
		<script src="/lotte/resources/<%= pubVersion %>/gucci_main.tpl.js"></script>
    <% } %>
</head>
<body ng-controller="GucciMainCtrl">
