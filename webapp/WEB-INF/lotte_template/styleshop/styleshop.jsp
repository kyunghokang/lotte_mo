...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/styleshop.min.css"/>
    <script src="/lotte/resources/<%= pubVersion %>/styleshop.min.js"></script>
    <script src="/lotte/resources/<%= pubVersion %>/styleshop.tpl.js"></script>
</head>
<body ng-controller="StyleShopCtrl">
