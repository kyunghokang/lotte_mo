...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/style_push.min.css"/>
    <script src="/lotte/resources/<%= pubVersion %>/style_push.min.js"></script>
    <script src="/lotte/resources/<%= pubVersion %>/style_push.tpl.js"></script>
...
<body ng-controller="StylePushCtrl">
