...
<head>
    <meta charset="utf-8">
    <title>롯데닷컴-simpleSignMemberIdFindAfter</title>
    ...
    <!-- 이 화면에서 쓰이는 JS -->
    <script src="/lotte/resources_dev/login/find_id_after.js"></script>
    <% } else {  %>
	    <%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/simpleSignMemberIdFindAfter.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/simpleSignMemberIdFindAfter.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/simpleSignMemberIdFindAfter.tpl.js"></script>
    <% } %>
...
<body ng-controller="findIdAfterCtrl">
