...
<head>
    <meta charset="utf-8">
    <title>롯데닷컴-simpleSignMemberPWFind</title>
    ...
    <!-- 이 화면에서 쓰이는 JS -->
    <script src="/lotte/resources_dev/login/find_pw.js"></script>

    <% } else {  %>
	    <%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/simpleSignMemberPWFind.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/simpleSignMemberPWFind.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/simpleSignMemberPWFind.tpl.js"></script>
    <% } %>

</head>
<body ng-controller="findPwCtrl">
