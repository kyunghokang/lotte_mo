...
<head>
    <meta charset="utf-8">
    <title>롯데닷컴-simpleSignMemberPWChange</title>
    ...
    <!-- 이 화면에서 쓰이는 JS -->
    <script src="/lotte/resources_dev/login/change_pw.js"></script>

    <% } else {  %>
	    <%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/simpleSignMemberPWChange.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/simpleSignMemberPWChange.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/simpleSignMemberPWChange.tpl.js"></script>
    <% } %>
</head>
<body ng-controller="changePwCtrl">
