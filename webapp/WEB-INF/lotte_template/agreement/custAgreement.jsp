...
<head>
    ...
    <!-- 이 화면에서 쓰이는 CSS -->
    <link rel="stylesheet" type="text/css" href="/lotte/resources_dev/agreement/cust_agreement.css"/>

    <!-- common js -->
    <%@include file="/angular_common/lotte_common_js.jsp"%>
    
    <!-- 이 화면에서 쓰이는 JS -->
    <script src="/lotte/resources_dev/agreement/cust_agreement.js"></script>

    <% } else {  %>
    	<%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/custAgreement.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/custAgreement.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/custAgreement.tpl.js"></script>
    <% } %>
    
</head>
<body ng-controller="CustAgreementCtrl">
