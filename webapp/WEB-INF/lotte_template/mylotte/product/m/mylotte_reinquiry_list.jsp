...
<head>
    ...
    <% if (LOTTE_DEVEL_MODE) { %>
	    ...
	    <!-- 이 화면에서 쓰이는 CSS -->
		<link rel="stylesheet" type="text/css" href="/lotte/resources_dev/mylotte/product/m/mylotte_reinquiry_list.css"/>
	    <!-- 이 화면에서 쓰이는 JS -->
    	<script src="/lotte/resources_dev/mylotte/product/m/mylotte_reinquiry_list.js"></script>
    <% } else {  %>
	    <%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/mylotte_reinquiry_list.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/mylotte_reinquiry_list.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/mylotte_reinquiry_list.tpl.js"></script>
    <% } %>
</head>
<body ng-controller="mylotteReinquiryListCtrl">
