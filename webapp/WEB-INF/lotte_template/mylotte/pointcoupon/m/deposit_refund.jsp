...
<head>
    ...
    <!-- 이 화면에서 쓰이는 JS -->
    <script src="/lotte/resources_dev/mylotte/pointcoupon/m/deposit_refund.js"></script>

    <% } else {  %>
    	<%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/deposit_refund.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/deposit_refund.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/deposit_refund.tpl.js"></script>
    <% } %>

</head>
<body ng-controller="DepositRefundCtrl">
