...
<head>
    ...
    <!-- 이 화면에서 쓰이는 JS -->
    <script src="/lotte/resources_dev/mylotte/pointcoupon/m/event_detail.js"></script>

    <% } else {  %>
    	<%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/event_detail.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/event_detail.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/event_detail.tpl.js"></script>
    <% } %>
