...
<head>
    ...
    <!-- 이 화면에서 쓰이는 CSS -->
    <link rel="stylesheet" type="text/css" href="/lotte/resources_dev/mylotte/pointcoupon/m/point_info.css"/>

    <!-- common js -->
    <%@include file="/angular_common/lotte_common_js.jsp"%>
    
    <!-- 이 화면에서 쓰이는 JS -->
    <script src="/lotte/resources_dev/mylotte/pointcoupon/m/point_info.js"></script>

    <% } else {  %>
    	<%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/point_info.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/point_info.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/point_info.tpl.js"></script>
    <% } %>

</head>
<body ng-controller="PointInfoCtrl">
