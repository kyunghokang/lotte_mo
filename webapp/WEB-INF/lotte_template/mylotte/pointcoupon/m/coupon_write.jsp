...
<head>
    ...
    <!-- 이 화면에서 쓰이는 JS -->
    <script src="/lotte/resources_dev/mylotte/pointcoupon/m/coupon_write.js"></script>

    <% } else {  %>
    	<%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/coupon_write.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/coupon_write.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/coupon_write.tpl.js"></script>
    <% } %>

</head>
<body ng-controller="CouponWriteCtrl">
