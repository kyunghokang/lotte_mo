...
<head>
    <meta charset="utf-8">
    <title>롯데닷컴-comment_rewrite</title>
    ...
    <% if (LOTTE_DEVEL_MODE) { %>
	    ...
	    <link rel="stylesheet" type="text/css" href="/lotte/resources_dev/product/m/comment_write.css"/>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources_dev/sns/sns.css"/>
	    <!-- 이 화면에서 쓰이는 JS -->
	    <script src="/lotte/lib/kakao/kakao.js"></script>
	    <script src="/lotte/resources_dev/product/m/comment_rewrite.js"></script>
	    <script src="/lotte/resources_dev/sns/lotte_sns.js"></script>
    <% } else {  %>
	    <%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/comment_rewrite.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/comment_rewrite.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/comment_rewrite.tpl.js"></script>
    <% } %>
</head>
<body ng-controller="commentRewriteCtrl">
