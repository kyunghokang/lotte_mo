...
<head>
	<meta charset="utf-8">
	<title>롯데닷컴-product_collect_benefits</title>
	...
	<link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/product_collect_benefits.min.css"/>
	<script src="/lotte/resources/<%= pubVersion %>/product_collect_benefits.min.js"></script>
	<script src="/lotte/resources/<%= pubVersion %>/product_collect_benefits.tpl.js"></script>
</head>
<body ng-controller="ProductCollectBenefitsCtrl">
