...
<head>
	<meta charset="utf-8">
	<title>롯데닷컴-product_benefit_compare</title>
	...
	<link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/product_benefit_compare.min.css"/>
	<script src="/lotte/resources/<%= pubVersion %>/product_benefit_compare.min.js"></script>
	<script src="/lotte/resources/<%= pubVersion %>/product_benefit_compare.tpl.js"></script>
</head>
<body ng-controller="ProductBenefitCompareCtrl">
