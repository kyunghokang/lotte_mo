...
<head>
	<meta charset="utf-8">
	<title>롯데닷컴-product_ext_info</title>
	...
	<link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/product_ext_info.min.css"/>
	<script src="/lotte/resources/<%= pubVersion %>/product_ext_info.min.js"></script>
	<script src="/lotte/resources/<%= pubVersion %>/product_ext_info.tpl.js"></script>
</head>
<body ng-controller="ProductExtInfoCtrl">
