...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/product_qna.min.css"/>
	<script src="/lotte/resources/<%= pubVersion %>/product_qna.min.js"></script>
	<script src="/lotte/resources/<%= pubVersion %>/product_qna.tpl.js"></script>
</head>
<body ng-controller="ProductQnaCtrl">
