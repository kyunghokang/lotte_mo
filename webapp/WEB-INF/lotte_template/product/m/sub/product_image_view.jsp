...
<head>
	<meta charset="utf-8">
	<title>롯데닷컴-product_image_view</title>
	...
	<link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/product_image_view.min.css"/>
	<script src="/lotte/resources/<%= pubVersion %>/product_image_view.min.js"></script>
	<script src="/lotte/resources/<%= pubVersion %>/product_image_view.tpl.js"></script>
</head>
<body ng-controller="ProductImageViewCtrl">
