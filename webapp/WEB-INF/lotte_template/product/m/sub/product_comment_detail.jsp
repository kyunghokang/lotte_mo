...
<head>
	<meta charset="utf-8">
	<title>롯데닷컴-product_comment_detail</title>
	...
	<link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/product_comment_detail.min.css"/>
	<script src="/lotte/resources/<%= pubVersion %>/product_comment_detail.min.js"></script>
	<script src="/lotte/resources/<%= pubVersion %>/product_comment_detail.tpl.js"></script>
</head>
<body ng-controller="ProductCommentDetailCtrl">
