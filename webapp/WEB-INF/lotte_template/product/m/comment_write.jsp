...
<head>
    ...
    <% if (LOTTE_DEVEL_MODE) { %>
	    ...
	    <script src="/lotte/resources_dev/product/m/comment_write.js"></script>
	    <script src="/lotte/resources_dev/sns/lotte_sns.js"></script>
    <% } else {  %>
	    <%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/comment_write.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/comment_write.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/comment_write.tpl.js"></script>
    <% } %>
</head>
<body ng-controller="commentWriteCtrl">
