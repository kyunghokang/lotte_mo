...
<head>
    ...
    <!-- 이 화면에서 쓰이는 CSS -->
    <link rel="stylesheet" type="text/css" href="/lotte/resources_dev/product/m/product_list.css"/>
	...
	<script src="/lotte/resources_dev/product/m/product_list.js"></script>
	<script src="/lotte/lib/kakao/kakao.js"></script>
    
    <% } else {  %>
		<%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/product_list.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/product_list.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/product_list.tpl.js"></script>
