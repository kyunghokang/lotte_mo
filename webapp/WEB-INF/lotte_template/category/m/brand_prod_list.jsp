...
<head>
    ...
    <script src="/lotte/resources_dev/category/m/brand_prod_list.js"></script>
    <% } else {  %>
	    <%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/brand_prod_list.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/brand_prod_list.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/brand_prod_list.tpl.js"></script>
...
<body ng-controller="BrandSubCtrl">
