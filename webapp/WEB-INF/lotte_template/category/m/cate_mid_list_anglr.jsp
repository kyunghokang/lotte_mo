...
<head>
    <meta charset="utf-8">
    <title>롯데닷컴-cate_mid_list_anglr</title>
    ...
    <script src="/lotte/resources_dev/category/m/cate_mid_list_anglr.js"></script>
   	<script src="/lotte/resources_dev/layer/main_popup.js"></script>

    <% } else {  %>
	    <%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/cate_mid_list_anglr.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/cate_mid_list_anglr.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/cate_mid_list_anglr.tpl.js"></script>
...
<body ng-controller="CateMidListCtrl">
    ...
    <lotte-main-popup ppp_tgt_pg_cd="50"></lotte-main-popup>
