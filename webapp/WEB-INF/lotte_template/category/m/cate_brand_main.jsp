...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/lotte/resources_dev/unit/unit_01.css">
    <link rel="stylesheet" type="text/css" href="/lotte/resources_dev/brandshop/brand_common.css" >
    <link rel="stylesheet" type="text/css" href="/lotte/resources_dev/brandshop/brandshop.css"/>
    ...
    <script src="/lotte/resources_dev/category/m/cate_brand_main.js"></script>

    <% } else {  %>
	    <%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/cate_brand_main.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/cate_brand_main.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/cate_brand_main.tpl.js"></script>
...
<body ng-controller="BrandMainCtrl">
