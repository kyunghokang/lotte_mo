...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/lotte/resources_dev/webzine/m/lzine_detail.css"/>
    ...
    <script src="/lotte/resources_dev/webzine/m/lzine_detail.js"></script>

    <% } else {  %>
	    <%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/lzine_detail.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/lzine_detail.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/lzine_detail.tpl.js"></script>
    <% } %>
</head>
<body ng-controller="WineDetailCtrl">
