...
<head>
    ...
    <script src="/lotte/resources_dev/webzine/m/lzine_list.js"></script>

    <% } else {  %>
	    <%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/lzine_list.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/lzine_list.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/lzine_list.tpl.js"></script>
    <% } %>
</head>
<body ng-controller="lzineListCtrl">
