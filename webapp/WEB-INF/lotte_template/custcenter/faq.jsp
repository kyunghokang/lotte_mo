...
<head>
    ...
    <% } else {  %>
	    ...
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/faq.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/faq.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/faq.tpl.js"></script>
    <% } %>
