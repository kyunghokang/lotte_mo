...
<head>
    ...
    <% if (LOTTE_DEVEL_MODE) { %>
	    ...
	    <!-- 이 화면에서 쓰이는 JS -->
		<script src="/lotte/resources_dev/custcenter/m/answer_detail.js"></script>    
    <% } else {  %>
	    <%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/answer_detail.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/answer_detail.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/answer_detail.tpl.js"></script>
    <% } %>
</head>
<body ng-controller="answerDetailCtrl" style="background-color:#f2f2f2">
