...
<head>
    ...
    <% if (LOTTE_DEVEL_MODE) { %>
    	...
    	<!-- 이 화면에서 쓰이는 JS -->
    	<script src="/lotte/resources_dev/custcenter/m/answer.js"></script>
    <% } else {  %>
	    <%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/answer.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/answer.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/answer.tpl.js"></script>
    <% } %>
</head>
<body ng-controller="answerCtrl">
