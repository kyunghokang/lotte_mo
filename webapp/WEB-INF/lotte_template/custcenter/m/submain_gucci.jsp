...
<head>
    ...
    <!-- 이 화면에서 쓰이는 CSS -->
    <link rel="stylesheet" type="text/css" href="/lotte/resources_dev/custcenter/cscenter_main.css"/>
    ...
    <!-- 이 화면에서 쓰이는 JS -->
	<script src="/lotte/resources_dev/custcenter/faq.js"></script>
    
    <% } else {  %>
    	<%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/submain_gucci.min.css"/>
    	<script src="/lotte/resources/<%= pubVersion %>/submain_gucci.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/submain_gucci.tpl.js"></script>
    <% } %>

</head>
<body ng-controller="cscenterFaqCtrl">
