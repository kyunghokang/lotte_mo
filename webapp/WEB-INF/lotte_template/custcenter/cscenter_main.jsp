...
<head>
    ...
    <!-- 이 화면에서 쓰이는 JS -->
	<script src="/lotte/resources_dev/custcenter/cscenter_main.js"></script>
    
    <% } else {  %>
    	<%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/cscenter_main.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/cscenter_main.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/cscenter_main.tpl.js"></script>
    <% } %>

</head>
<body ng-controller="cscenterMainCtrl">
