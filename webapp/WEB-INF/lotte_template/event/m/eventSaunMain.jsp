...
<head>
    ...
    <!-- 이 화면에서 쓰이는 CSS -->
    <link rel="stylesheet" type="text/css" href="/lotte/resources_dev/event/m/event.css"/>
    ...
    <!-- 이 화면에서 쓰이는 JS -->
    <script src="/lotte/resources_dev/event/m/eventSaunMain.js"></script>
    ...
    <% } else {  %>
	    ...
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/eventSaunMain.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/eventSaunMain.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/eventSaunMain.tpl.js"></script>
    <% } %>
    
</head>
<body ng-controller="EventSaunMainCtrl">
