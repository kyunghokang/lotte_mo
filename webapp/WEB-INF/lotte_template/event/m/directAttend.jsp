...
<head>
    ...
    <!-- 이 화면에서 쓰이는 CSS -->
    <link rel="stylesheet" type="text/css" href="/lotte/resources_dev/event/direct_attend.css"/>

    <!-- common js -->
    <%@include file="/angular_common/lotte_common_js.jsp"%>
    
    <!-- 이 화면에서 쓰이는 JS -->
    <script src="/lotte/resources_dev/event/direct_attend.js"></script>

    <% } else {  %>
    	<%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/directAttend.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/directAttend.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/directAttend.tpl.js"></script>
    	
    <% } %>
</head>
<body ng-controller="directAttendCtrl">
