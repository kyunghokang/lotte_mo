...
<head>
    <meta charset="utf-8">
    <title>롯데닷컴-Dear Petstagram</title>
    ...
    <!-- 이 화면에서 쓰이는 CSS -->
    <link rel="stylesheet" type="text/css" href="/lotte/resources_dev/instagram/instagram_list.css"/>
    
    <!-- 이 화면에서 쓰이는 JS -->
    <script src="/lotte/resources_dev/instagram/instagram_list.js"></script>
    

    <% } else {  %>
        <%@include file="/common3/html_meta_angular.jsp"%>
        <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/instagram_list.min.css"/>
        <script src="/lotte/resources/<%= pubVersion %>/instagram_list.min.js"></script>
        <script src="/lotte/resources/<%= pubVersion %>/instagram_list.tpl.js"></script>
    <% } %>
</head>
<body ng-controller="instagramListCtrl">
