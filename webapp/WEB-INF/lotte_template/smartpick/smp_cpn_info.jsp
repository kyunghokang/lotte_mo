...
<head>
	...
	<script src="/lotte/resources_dev/smartpick/pick_view.js"></script>
	<script src="/lotte/resources_dev/common/lotte_navermap.js"></script>
    
    <% } else {  %>
    	<%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/smp_cpn_info.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/smp_cpn_info.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/smp_cpn_info.tpl.js"></script>
    <% } %>
	<%
...
<body ng-controller="SmartPickViewCtrl" class="<%=css%>">
