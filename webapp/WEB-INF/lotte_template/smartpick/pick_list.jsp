...
<head>
	...
	<script src="/lotte/resources_dev/smartpick/pick_list.js"></script>
    
    <% } else {  %>
    	<%@include file="/common3/html_meta_angular.jsp"%>
	    <link rel="stylesheet" type="text/css" href="/lotte/resources/<%= pubVersion %>/pick_list.min.css"/>
	    <script src="/lotte/resources/<%= pubVersion %>/pick_list.min.js"></script>
	    <script src="/lotte/resources/<%= pubVersion %>/pick_list.tpl.js"></script>
    <% } %>
    <%
...
<body ng-controller="SmartPickCtrl" class="<%=css%> list">
