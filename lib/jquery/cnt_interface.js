...
var isLogin = false,
    ...
    isApp = false;
function loginChk() {
	return isLogin || angular.element('html').scope().loginInfo.isLogin;
}
$(window).load(function(){isLogin = angular.element('html').scope().loginInfo.isLogin});
/*Device check*/
